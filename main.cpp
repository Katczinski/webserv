    ...
    if (argc > 2) {
        ...
        try {
            ...
            */
            ...
            // std::cout << "Loc root: " << configs.front().getLocation("/")->second.getRoot() << std::endl;
            // std::cout << "Index: " << configs.front().getLocation("/")->second.getIndex().front() << std::endl;
            // std::cout << "Allow method: " << configs.front().getLocation("/")->second.getMethods().front() << std::endl;
            // std::cout << "Max Body: " << configs.front().getLocation("/")->second.getMaxBody() << std::endl;
            // std::cout << "CGI extension: " << configs.front().getLocation("/")->second.getCgiExtension() << std::endl;
            // std::cout << "CGI path: " << configs.front().getLocation("/")->second.getCgiPath() << std::endl;
